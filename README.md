The Application is fully based on Core Data Processing. The Xml file is used to get the data to the core data, then the TableViewController is used to fetch the data.
